...
\begin{itemize}
\item High Energy Physicist, focused on making model-independent measurements with the ATLAS experiment and re-interpreting existing model-independent results to set novel constraints on physics beyond the Standard Model.
...
\item Migrated semantic embedding hosting from in app memory to a bespoke Postgres server, providing a stable and scalable service that can meet the demands of the tool's growing popularity.
